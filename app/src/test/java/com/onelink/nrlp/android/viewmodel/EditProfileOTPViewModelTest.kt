...
class EditProfileOTPViewModelTest : BaseViewModelTest() {
    ...
    private lateinit var viewModel: EditProfileOtpFragmentViewModel
    ...
    override fun setUp() {
        super.setUp()
        viewModel = EditProfileOtpFragmentViewModel(profileRepo)
    }
