...
class VerifyBeneficiaryViewModelTest : BaseViewModelTest() {
    ...
    private lateinit var viewModel: VerifyBeneficiaryFragmentViewModel
    ...
    override fun setUp() {
        super.setUp()
        viewModel = VerifyBeneficiaryFragmentViewModel(registerRepo)
    }
    ...
    fun getOTPSuccess() {
        ...
        assertNotNull(viewModel.getRegistrationCode())
        ...
        assertEquals(4, viewModel.getRegistrationCode().length)

        assertEquals(
            OTP1 + OTP2 + OTP3 + OTP4,
            viewModel.getRegistrationCode()
        )
