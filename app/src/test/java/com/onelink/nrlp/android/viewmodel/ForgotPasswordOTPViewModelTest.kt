...
class ForgotPasswordOTPViewModelTest : BaseViewModelTest() {
    ...
    private lateinit var viewModel: ForgotPasswordOTPFragmentViewModel
    ...
    override fun setUp() {
        super.setUp()
        viewModel = ForgotPasswordOTPFragmentViewModel(forgotPasswordRepo)
    }
