...
class OtpAuthenticationViewModelTest : BaseViewModelTest() {
    ...
    private lateinit var viewModel: OtpAuthenticationFragmentViewModel

    @Mock
    private lateinit var loginRepo: RegisterRepo


    override fun setUp() {
        super.setUp()
        viewModel = OtpAuthenticationFragmentViewModel(loginRepo)
    }
