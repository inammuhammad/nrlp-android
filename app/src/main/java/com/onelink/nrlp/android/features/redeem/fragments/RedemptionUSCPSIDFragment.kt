...
import com.onelink.nrlp.android.databinding.FragmentRedemptionUscPsidBinding
...
import com.onelink.nrlp.android.features.redeem.viewmodels.RedemptionUSCPSIDViewModel
...
class RedemptionUSCPSIDFragment : BaseFragment<RedemptionUSCPSIDViewModel,FragmentRedemptionUscPsidBinding>
    (RedemptionUSCPSIDViewModel::class.java), OneLinkAlertAmountDialogFragment.OneLinkAlertDialogListeners {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = RedemptionUSCPSIDFragment()
    }

    override fun getTitle(): String = resources.getString(R.string.redeem)
    override fun getLayoutRes() = R.layout.fragment_redemption_usc_psid
    override fun getViewM(): RedemptionUSCPSIDViewModel =
        ViewModelProvider(this,viewModelFactory).get(RedemptionUSCPSIDViewModel::class.java)
