...
import com.onelink.nrlp.android.databinding.FragmentRedemptionNadraDescriptionBinding
import com.onelink.nrlp.android.features.redeem.viewmodels.RedeemSharedViewModel
import com.onelink.nrlp.android.features.redeem.viewmodels.RedemptionNadraDescriptionViewModel
...
class RedemptionNadraDescriptionFragment : BaseFragment<RedemptionNadraDescriptionViewModel,FragmentRedemptionNadraDescriptionBinding>
    (RedemptionNadraDescriptionViewModel::class.java)  {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = RedemptionNadraDescriptionFragment()
    }

    override fun getTitle(): String = resources.getString(R.string.redeem)
    override fun getLayoutRes() = R.layout.fragment_redemption_nadra_description
    override fun getViewM(): RedemptionNadraDescriptionViewModel =
        ViewModelProvider(this,viewModelFactory).get(RedemptionNadraDescriptionViewModel::class.java)
