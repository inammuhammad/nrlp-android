...
class OneLinkAlertAmountDialogFragment : DialogFragment() {
    ...
    companion object {
        fun newInstance(
            ...
            negativeButtonText: String = ""
                ...
                OneLinkAlertAmountDialogFragment {
            val oneLinkAlertDialogsFragment = OneLinkAlertAmountDialogFragment()
            val args = Bundle()
    ...
    class Builder {
        private val instance = OneLinkAlertAmountDialogFragment()
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.amount_dialog, container)
    }
    ...
    interface OneLinkAlertDialogListeners {
        ...
        fun onPositiveButtonClicked(targetCode: Int,amount: Int)
