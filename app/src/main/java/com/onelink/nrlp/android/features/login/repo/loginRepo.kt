...
open class LoginRepo @Inject constructor(
    ...
    fun getUserModelFromLoginResponse(loginResponseModel: LoginResponseModel): UserModel {
        return UserModel(
            ...
            residentId = loginResponseModel.loginModel.residentId,
            passportType = loginResponseModel.loginModel.passportType,
            passportId = loginResponseModel.loginModel.passportId,
