...
class ComplaintSharedViewModel @Inject constructor(private val complainRepo: ComplainRepo) : BaseViewModel() {
    ...
    fun getComplaintType():Int{
        return when(complaintText.value!!.toLowerCase(Locale.getDefault())){
            UnregisteredComplaintTypes.UNABLE_TO_REGISTER -> 1
            UnregisteredComplaintTypes.UNABLE_TO_RECEIVE_REGISTRATION_CODE -> 2
            UnregisteredComplaintTypes.UNABLE_TO_RECEIVE_OTP -> 3
            else -> 8
        }
    }
    ...
    fun gotoComplaintTypeFragment(
        ...
        fragmentHelper.addFragment(
            ComplaintTypeFragment.newInstance(),
    ...
    fun gotoComplaintResponseFragment(
        ...
        fragmentHelper.addFragment(
            ComplaintResponseFragment.newInstance(),
            clearBackStack = true,
