...
import com.onelink.nrlp.android.databinding.FragmentComplaintDetailsBinding
...
class ComplaintDetailsFragment :
    BaseFragment<ComplaintSharedViewModel, FragmentComplaintDetailsBinding>(
    ...
    private fun initObservers() {
        ...
        (activity as ComplaintActivity).selectedCountry.observe(this, androidx.lifecycle.Observer { countryCodeModel ->
        ...
        /*viewModel.ccountryNotEmpty.observe(this, {
            binding.tvCountry.isClickable = it
        })*/
    ...
    private fun getAddComplainRequestModel():AddComplaintRequestModel{
        return AddComplaintRequestModel(
        Registered = UNREGISTERED,
        User_Type = viewModel.userType.value.toString().toLowerCase(Locale.getDefault()),
        Complaint_Type_Id = viewModel.complaintTypeIndex.value!!.toInt(),
        NIC_NICOP = binding.etCnic.text.toString().removeDashes(),
        Name = binding.etName.text.toString(),
        Mobile_No = binding.tvCountryCode.text.toString() + binding.etPhoneNumber.text.toString(),
        Email = binding.etEmail.text.toString(),
        Country_of_residence = binding.tvCountry.text.toString(),
        Comments = details
        )
    }
    private fun getComplaintRequestJsonObject() : JsonObject
    {
        ...
        if(viewModel.complaintText.value!!.toLowerCase(Locale.getDefault())==
                UnregisteredComplaintTypes.UNABLE_TO_RECEIVE_REGISTRATION_CODE )
            {
                requestModel.addProperty(
                ...
                UnregisteredComplaintTypes.UNABLE_TO_RECEIVE_OTP){
            requestModel.addProperty(
                ComplaintRequestModelConstants.Mobile_Operator,
                binding.etMobileOperator.text.toString()
            )
    ...
    override fun getLayoutRes()= R.layout.fragment_complaint_details
